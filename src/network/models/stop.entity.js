export class StopEntity {
  constructor(id, name, google_maps_url, image_url, fk_id_driver, fk_id_district, address, reference) {
    ...
    if (!fk_id_driver || typeof fk_id_driver !== 'number' || !Number.isInteger(fk_id_driver)) {
    ...
    this.fk_id_driver = fk_id_driver
    this.fk_id_company = fk_id_driver
